...
use ResponsiveMenuPro\Database\Migration;
use ResponsiveMenuPro\Models\Option;

class MigrationTest extends TestCase {

    public function setUp() {
      $this->database = $this->createMock('ResponsiveMenuPro\Database\WpDatabase');
      ...
      $this->old_options = ['default_one' => 4, 'default_two' => 'old string', 'default_three' => 4.5, 'menu' => 'old RM value', 'depth' => 'old RMDepth value'];
    ...
    public function testOptionsToMigrate() {
      $this->assertSame(
        ['menu_to_use' => 'old RM value',
        'menu_depth' => 'old RMDepth value',
        'menu_word_wrap' => 'off'],
        $this->base_migration->getMigratedOptions()
      );
    }
    ...
    public function testAddNewOptionsEmpty() {
      $service = $this->createMock('ResponsiveMenuPro\Services\OptionService');
      $service->method('all')->willReturn(new ResponsiveMenuPro\Collections\OptionsCollection);
