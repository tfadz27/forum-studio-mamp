...
class OptionFactoryTest extends TestCase {
  ...
  public function setUp() {
    ...
    $helpers = ['a' => ['filter' => 'ResponsiveMenuPro\Filters\HtmlFilter'], 'c' => ['filter' => 'ResponsiveMenuPro\Filters\JsonFilter']];
    $this->factory = new ResponsiveMenuPro\Factories\OptionFactory($defaults, $helpers);
  }

  public function testSetFilterIsReturned() {
    $option = $this->factory->build('a', 4);
    $this->assertInstanceOf('ResponsiveMenuPro\Filters\HtmlFilter', $option->getFilter());
  }

  public function testDefaultFilterIsReturned() {
    $option = $this->factory->build('b', 4);
    $this->assertInstanceOf('ResponsiveMenuPro\Filters\TextFilter', $option->getFilter());
  }

  public function testOptionIsReturned() {
    $option = $this->factory->build('b', 4);
    $this->assertInstanceOf('ResponsiveMenuPro\Models\Option', $option);
  }
