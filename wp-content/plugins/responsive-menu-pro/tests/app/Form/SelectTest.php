...
class SelectTest extends TestCase {
  ...
  public function setUp() {
    $this->form_component = new ResponsiveMenuPro\Form\Select;
  }

  public function testRendering() {
    $options = [['value' => 1, 'display' => 'a'],['value' => 2, 'display' => 'b']];
    $output = $this->form_component->render(new ResponsiveMenuPro\Models\Option('a', 4), $options);
  ...
  public function testRenderingWithSelected() {
    $options = [['value' => 1, 'display' => 'a'],['value' => 2, 'display' => 'b']];
    $output = $this->form_component->render(new ResponsiveMenuPro\Models\Option('a', 2), $options);
