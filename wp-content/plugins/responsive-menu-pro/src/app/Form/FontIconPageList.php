...
class FontIconPageList implements FormComponent {
    ...
    $output = "<div class='font-icon-container'><div class='font-icon-row'><div class='font-icon-cell-id'>" . __('Id', 'responsive-menu-pro') . "</div><div class='font-icon-cell-icon'>" . __('Icon', 'responsive-menu-pro') . "</div></div>";
    ...
    if(is_array($final) && !empty($final)):
      ...
      $output .= "</div><div class='add-font-icon'>" . __('Add New Font Icon', 'responsive-menu-pro') . "</div>";
