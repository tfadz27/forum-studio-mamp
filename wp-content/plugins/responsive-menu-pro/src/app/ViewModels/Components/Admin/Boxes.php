...
namespace ResponsiveMenuPro\ViewModels\Components\Admin;
use ResponsiveMenuPro\Collections\OptionsCollection;
use ResponsiveMenuPro\Form;
          ...
          <div class="postbox" id="postbox_' . $this->i($sub_menu_name).'">
            <div class="handlediv">
              <button aria-expanded="true" class="button-link" type="button">
                <span class="screen-reader-text">' . __('Toggle panel: Location', 'responsive-menu-pro') . '</span>
            ...
            <div class="inside">
              ...
              $output .= '<tr id="' . $option['option'] . '_container">
                      <td>
  ...
  public function f($type, $option_name, $select) {
    switch($type):
      ...
      case 'export' : $comp = new Form\Export;
                        return $comp->render();
                        break;
      case 'license' : $comp = new Form\License;
                        return $comp->render();
                        break;
