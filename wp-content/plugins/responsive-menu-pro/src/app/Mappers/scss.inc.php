...
class scssc_pro {
	...
	protected $formatter = "scss_formatter_nested_pro";
    ...
    try {
  		...
  		$this->parser = new scss_parser_pro($name);
	...
	protected function injectVariables(array $args)
	{
		...
		$parser = new scss_parser_pro(__METHOD__, false);
	...
	protected function importFile($path, $out) {
		...
		if (isset($this->importCache[$realPath])) {
			...
			$parser = new scss_parser_pro($path, false);
...
class scss_parser_pro {
	...
	static protected function makeOperatorStr($operators) {
		return '('.implode('|', array_map(array('scss_parser_pro','preg_quote'),
			$operators)).')';
	}
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class scss_formatter_nested_pro extends scss_formatter_pro {
	public $close = " }";
 ...
 * @author Leaf Corcoran <leafot@gmail.com>
 */
class scss_formatter_compressed_pro extends scss_formatter_pro {
	public $open = "{";
	public $tagSeparator = ",";
	public $assignSeparator = ":";
	public $break = "";
