    ...
    __('Sizing', 'responsive-menu-pro') =>
      [
        ...
        [
          ...
          'title' => __('Border Width', 'responsive-menu-pro'),
          'label' => __('', 'responsive-menu-pro'),
          'semi_pro' => true,
          'sub_options' =>
          [
      ...
      __('Title', 'responsive-menu-pro') =>
        [
          ...
          [
            ...
            'title' => __('Alt Text', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro')
          ],
          [
    ...
    __('Border Colours', 'responsive-menu-pro') =>
      [
        ...
        [
          ...
          'title' => __('Current Item Border Colour', 'responsive-menu-pro'),
          'label' => __('', 'responsive-menu-pro'),
          'type' => 'colour',
          'semi_pro' => true
        ],
        [
          ...
          'title' => __('Current Item Border Colour Hover', 'responsive-menu-pro'),
          'label' => __('', 'responsive-menu-pro'),
          'type' => 'colour',
          'semi_pro' => true
        ]
...
*/
    __('Sub-Menus', 'responsive-menu-pro') => [
      ...
      __('Toggle Button Background Colours', 'responsive-menu-pro') =>
        [
          [
          ...
          [
            ...
            'title' => __('Background Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
          [
            ...
            'title' => __('Background Hover Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
        ],
      __('Toggle Button Border Colours', 'responsive-menu-pro') =>
        [
          [
          ...
          [
            ...
            'title' => __('Border Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
          [
            ...
            'title' => __('Border Hover Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
        ],
      __('Toggle Button Icon Colours', 'responsive-menu-pro') =>
        [
          [
          ...
          [
            ...
            'title' => __('Icon Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
          [
            ...
            'title' => __('Icon Hover Colour Active', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'colour',
            'semi_pro' => true
          ],
      ...
      __('Animations', 'responsive-menu-pro') =>
        [
          ...
          [
            ...
            'title' => __('Use slide effect instead of drop-down', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'checkbox',
            'pro' => true,
            'beta' => true
      ...
      __('Fade Links In', 'responsive-menu-pro') =>
        [
          [
            'option' => 'fade_submenus',
            'title' => __('Enabled', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'checkbox',
            'pro' => true
          ],
          [
            ...
            'title' => __('Fade from side', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'type' => 'select',
            'select' => [
              ['value' => 'left', 'display' => 'Left'],
          ...
          [
            ...
            'title' => __('Delay between items', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'unit' => 'ms',
            'pro' => true
          ],
          [
            ...
            'title' => __('Speed of fade', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
            'unit' => 'ms',
            'pro' => true
          ]
      ...
      __('Toggle Icons', 'responsive-menu-pro') =>
        [
          ...
          [
            ...
            'title' => __('Icon Position', 'responsive-menu-pro'),
            'label' => __('', 'responsive-menu-pro'),
              'type' => 'select',
              'select' => [
                ['value' => 'left', 'display' => 'Left'],
