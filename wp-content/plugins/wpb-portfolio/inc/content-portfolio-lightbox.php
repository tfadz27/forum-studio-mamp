...
<div class="wpb_fp_row">
	<div class="wpb_fp_quick_view_img <?php echo ( $images ? 'wpb_fp_has_gallery' : 'wpb_fp_no_gallery' );?> <?php echo ( $gallery_feature_image == 'on' ? 'wpb_fp_gallery_has_feature_image' : 'wpb_fp_gallery_disable_feature_image' );?> wpb_fp_col-md-6 wpb_fp_col-sm-12">
